...
var N = { map: I, forEach: I, count: function(n) {
...
var B2 = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;
  ...
  "string" == typeof n.type && function(n2) {
    ...
    for (var o in t) {
      ...
      if (!("value" === o && "defaultValue" in t && null == i || Y && "children" === o && "noscript" === e || "class" === o || "className" === o)) {
        var c = o.toLowerCase();
        "defaultValue" === o && "value" in t && null == t.value ? o = "value" : "download" === o && true === i ? i = "" : "translate" === c && "no" === i ? i = false : "ondoubleclick" === c ? o = "ondblclick" : "onchange" !== c || "input" !== e && "textarea" !== e || $(t.type) ? "onfocus" === c ? o = "onfocusin" : "onblur" === c ? o = "onfocusout" : H2.test(o) ? o = c : -1 === e.indexOf("-") && B2.test(o) ? o = o.replace(Z, "-$&").toLowerCase() : null === i && (i = void 0) : c = o = "oninput", "oninput" === c && u[o = c] && (o = "oninputCapture"), u[o] = i;
      }
    }
...
var Rn = { useState: h, useId: g, useReducer: p, useEffect: y, useLayoutEffect: _2, useInsertionEffect: gn, useTransition: Sn, useDeferredValue: bn, useSyncExternalStore: Cn, startTransition: _n, useRef: A, useImperativeHandle: F, useMemo: T, useCallback: q, useContext: x, useDebugValue: P, version: "17.0.2", Children: N, render: q2, hydrate: G2, unmountComponentAtNode: vn, createPortal: j, createElement: _, createContext: G, createFactory: ln, cloneElement: hn, createRef: m, Fragment: k, isValidElement: fn, isElement: En, isFragment: an, isMemo: sn, findDOMNode: dn, Component: b, PureComponent: C, memo: x2, forwardRef: k2, flushSync: mn, unstable_batchedUpdates: pn, StrictMode: yn, Suspense: L, SuspenseList: U, lazy: F2, __SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED: on };
...
function rankRouteBranches(branches) {
  branches.sort((a, b3) => a.score !== b3.score ? b3.score - a.score : compareIndexes(a.routesMeta.map((meta) => meta.childrenIndex), b3.routesMeta.map((meta) => meta.childrenIndex)));
}
var paramRe = /^:[\w-]+$/;
...
function compareIndexes(a, b3) {
  let siblings = a.length === b3.length && a.slice(0, -1).every((n, i) => n === b3[i]);
  return siblings ? (
    // If two routes are siblings, we should try to match the earlier sibling
    // first. This allows people to have fine-grained control over the matching
    // behavior by simply putting routes with identical paths in the order they
    // want them tried.
    a[a.length - 1] - b3[b3.length - 1]
  ) : (
...
var DeferredData = class {
  constructor(data, responseInit) {
    ...
    let reject;
    this.abortPromise = new Promise((_3, r) => reject = r);
  ...
  cancel() {
    ...
    this.pendingKeysSet.forEach((v, k3) => this.pendingKeysSet.delete(k3));
    this.emit(true);
  }
...
function getMatchesToLoad(history, state, matches, submission, location, isInitialLoad, skipActionErrorRevalidation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, deletedFetchers, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionResult) {
  ...
  fetchLoadMatches.forEach((f, key) => {
    if (isInitialLoad || !matches.some((m2) => m2.route.id === f.routeId) || deletedFetchers.has(key)) {
      return;
    }
...
async function callDataStrategyImpl(dataStrategyImpl, type, request, matchesToLoad, matches, manifest, mapRouteProperties2, requestContext) {
  ...
  return results.filter((_3, i) => routeIdsToLoad.has(matches[i].route.id));
}
async function callLoaderOrAction(type, request, match, manifest, mapRouteProperties2, handlerOverride, staticContext) {
  ...
  let runHandler = (handler) => {
    let reject;
    let abortPromise = new Promise((_3, r) => reject = r);
    onReject = () => reject();
...
function isHashChangeOnly(a, b3) {
  if (a.pathname !== b3.pathname || a.search !== b3.search) {
    return false;
  }
  if (a.hash === "") {
    return b3.hash !== "";
  } else if (a.hash === b3.hash) {
    return true;
  } else if (b3.hash !== "") {
    return true;
  }
...
function restoreAppliedTransitions(_window, transitions) {
  try {
    ...
    if (sessionPositions) {
      ...
      for (let [k3, v] of Object.entries(json3 || {})) {
        if (v && Array.isArray(v)) {
          transitions.set(k3, new Set(v || []));
        }
      }
    }
  } catch (e) {
...
var DataRouterContext = G(null);
if (true) {
  DataRouterContext.displayName = "DataRouter";
}
var DataRouterStateContext = G(null);
if (true) {
  DataRouterStateContext.displayName = "DataRouterState";
}
var AwaitContext = G(null);
if (true) {
  AwaitContext.displayName = "Await";
}
var NavigationContext = G(null);
if (true) {
  NavigationContext.displayName = "Navigation";
}
var LocationContext = G(null);
if (true) {
...
function useMatch(pattern) {
  ...
  return T(() => matchPath(pattern, decodePath(pathname)), [pathname, pattern]);
}
...
function useNavigateUnstable() {
  ...
  let navigate = q(function(to, options) {
    if (options === void 0) {
      options = {};
    }
...
function useOutlet(context) {
  ...
  if (outlet) {
    return _(OutletContext.Provider, {
      value: context
    }, outlet);
  }
  return outlet;
...
function useResolvedPath(to, _temp2) {
  ...
  let routePathnamesJson = JSON.stringify(getResolveToMatches(matches, future.v7_relativeSplatPath));
  return T(() => resolveTo(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [to, routePathnamesJson, locationPathname, relative]);
}
...
` + ('Please change the parent <Route path="' + parentPath + '"> to <Route ') + ('path="' + (parentPath === "/" ? "*" : parentPath + "/*") + '">.'));
  ...
  if (locationArg && renderedMatches) {
    return _(LocationContext.Provider, {
      value: {
        location: _extends2({
          pathname: "/",
          search: "",
...
function DefaultErrorComponent() {
  ...
  if (true) {
    ...
    devInfo = _(k, null, _("p", null, "💿 Hey developer 👋"), _("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", _("code", {
      style: codeStyles
    }, "ErrorBoundary"), " or", " ", _("code", {
      style: codeStyles
    }, "errorElement"), " prop on your route."));
  }
  return _(k, null, _("h2", null, "Unexpected Application Error!"), _("h3", {
    style: {
      fontStyle: "italic"
    }
  }, message), stack ? _("pre", {
...
var defaultErrorElement = _(DefaultErrorComponent, null);
var RenderErrorBoundary = class extends b {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    return this.state.error !== void 0 ? _(RouteContext.Provider, {
      value: this.props.routeContext
    }, _(RouteErrorContext.Provider, {
...
function RenderedRoute(_ref) {
  ...
  return _(RouteContext.Provider, {
    value: routeContext
  }, children);
}
  ...
  return renderedMatches.reduceRight((outlet, match, index) => {
    ...
    let getChildren = () => {
      ...
      if (error) {
        ...
        children = _(match.route.Component, null);
      } else if (match.route.element) {
        children = match.route.element;
      } else {
        children = outlet;
      }
      return _(RenderedRoute, {
        match,
        routeContext: {
          outlet,
          matches: matches2,
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index === 0) ? _(RenderErrorBoundary, {
...
function useMatches() {
  ...
  return T(() => matches.map((m2) => convertRouteMatchToUiMatch(m2, loaderData)), [matches, loaderData]);
}
...
function useBlocker(shouldBlock) {
  ...
  let [blockerKey, setBlockerKey] = h("");
  let blockerFunction = q((arg) => {
...
var startTransitionImpl = compat_module_exports[START_TRANSITION];
function MemoryRouter(_ref3) {
  ...
  let setState = q((newState) => {
    v7_startTransition && startTransitionImpl ? startTransitionImpl(() => setStateImpl(newState)) : setStateImpl(newState);
  }, [setStateImpl, v7_startTransition]);
  _2(() => history.listen(setState), [history, setState]);
  return _(Router, {
    basename,
    children,
    location: state.location,
...
function Navigate(_ref4) {
  ...
  y(() => navigate(JSON.parse(jsonPath), {
    replace: replace2,
    state,
    relative
...
function Router(_ref5) {
  ...
  return _(NavigationContext.Provider, {
    value: navigationContext
  }, _(LocationContext.Provider, {
    children,
...
function Await(_ref7) {
  ...
  return _(AwaitErrorBoundary, {
    resolve,
    errorElement
  }, _(ResolveAwait, null, children));
}
...
var AwaitErrorBoundary = class extends b {
  constructor(props) {
    super(props);
    this.state = {
      error: null
  ...
  render() {
    ...
    if (status === AwaitRenderStatus.error) {
      return _(AwaitContext.Provider, {
        value: promise,
        children: errorElement
      });
    }
...
function createRoutesFromChildren(children, parentPath) {
  ...
  let routes = [];
  N.forEach(children, (element, index) => {
    if (!fn(element)) {
      return;
    }
...
function mapRouteProperties(route) {
  ...
  if (route.HydrateFallback) {
    ...
    Object.assign(updates, {
      hydrateFallbackElement: _(route.HydrateFallback),
  ...
  if (route.ErrorBoundary) {
    ...
    Object.assign(updates, {
      errorElement: _(route.ErrorBoundary),
...
var ViewTransitionContext = G({
  isTransitioning: false
});
if (true) {
  ViewTransitionContext.displayName = "ViewTransition";
}
var FetchersContext = G(/* @__PURE__ */ new Map());
if (true) {
  FetchersContext.displayName = "Fetchers";
}
var START_TRANSITION2 = "startTransition";
var startTransitionImpl2 = compat_module_exports[START_TRANSITION2];
var FLUSH_SYNC = "flushSync";
var flushSyncImpl = compat_module_exports[FLUSH_SYNC];
var USE_ID = "useId";
var useIdImpl = compat_module_exports[USE_ID];
...
function RouterProvider(_ref) {
  ...
  let [state, setStateImpl] = h(router.state);
  let [pendingState, setPendingState] = h();
  let [vtContext, setVtContext] = h({
    isTransitioning: false
  });
  let [renderDfd, setRenderDfd] = h();
  let [transition, setTransition] = h();
  let [interruption, setInterruption] = h();
  let fetcherData = A(/* @__PURE__ */ new Map());
  let {
    v7_startTransition
  } = future || {};
  let optInStartTransition = q((cb) => {
  ...
  _2(() => router.subscribe(setState), [router, setState]);
  y(() => {
  ...
  return _(k, null, _(DataRouterContext.Provider, {
    value: dataRouterContext
  }, _(DataRouterStateContext.Provider, {
    value: state
  }, _(FetchersContext.Provider, {
    value: fetcherData.current
  }, _(ViewTransitionContext.Provider, {
    value: vtContext
  }, _(Router, {
    basename,
    location: state.location,
    ...
    navigator,
    future: routerFuture
  }, state.initialized || router.future.v7_partialHydration ? _(MemoizedDataRoutes, {
    routes: router.routes,
    future: router.future,
    state
  }) : fallbackElement))))), null);
}
var MemoizedDataRoutes = x2(DataRoutes);
...
var Link = k2(function LinkWithRef(_ref7, ref) {
  let {
    onClick,
    relative,
    reloadDocument,
...
var NavLink = k2(function NavLinkWithRef(_ref8, ref) {
  let {
...
var Form = k2((_ref9, forwardedRef) => {
  let {
    fetcherKey,
    navigate,
    reloadDocument,
...
function useSearchParams(defaultInit) {
  ...
  let navigate = useNavigate();
  let setSearchParams = q((nextInit, navigateOptions) => {
...
function useSubmit() {
  ...
  return q(function(target, options) {
    if (options === void 0) {
      options = {};
    }
...
function useFetcher(_temp3) {
  ...
  let [fetcherKey, setFetcherKey] = h(key || defaultKey);
  ...
  let FetcherForm = T(() => {
    let FetcherForm2 = k2((props, ref) => {
      return _(Form, _extends3({}, props, {
        navigate: false,
        fetcherKey,
        ref
      }));
  ...
  let fetcherWithComponents = T(() => _extends3({
    Form: FetcherForm,
    submit,
    load
  }, fetcher, {
